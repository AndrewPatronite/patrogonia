...
import { Cave, Town } from '../maps/Maps'
...
describe('Tile', () => {
  ...
  const map = {
    layout: [
      ...
      [W, W, W, W, W, W, W, W, W, W],
      [W, W, W, W, W, W, W, W, W, W],
      [W, W, W, W, W, G, Town.Dewhurst, W, W, W],
      [W, W, W, W, Cave.LavaGrotto, G, G, W, W, W],
      [W, W, W, W, G, G, G, W, W, W],
      [W, W, W, W, W, W, W, W, W, W],
      [W, W, W, W, W, W, W, W, W, W],
    ],
  ...
  it('has the expected classNames and shows the entrance name as mapsymbol', () => {
    ...
    expect(subject.getAttribute('mapsymbol')).toEqual(Cave.LavaGrotto)
  })
